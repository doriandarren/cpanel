...
<div class="row">
    <div class="panel panel-info">
        ...
        <div class="panel-body"><?php
            ...
            <div class="form-group">
                <label for="usuarios_tipos_id" class="col-sm-2 control-label">usuarios tipos</label> 
                <div class="col-sm-4">
                    <select name="usuarios_tipos_id" class="form-control" id="usuarios_tipos_id">
                        <?php
                        echo "<option value=''>Seleccione</option>";
                        foreach ($lista_usuarios_tipos as $rows) {
                            if (usuarios_tipos_id == $rows->id) {
...
<?php echo form_error('usuarios_tipos_id'); ?>
                </div>
            </div>
